...
//
//public class CopyOfIDisplayOpenGLView extends GLSurfaceView implements Renderer, Observer {
...
//    }
//
//    public CopyOfIDisplayOpenGLView(Context context, MiniMapProcessor miniMapProcessor, OnMeasureListener onMeasureListener) {
//        super(context);
//
//    	boolean z = true;
...
//                return CopyOfIDisplayOpenGLView.this.mHeight;
//            }
//
//            public int getDataStrideX() {
//                return CopyOfIDisplayOpenGLView.this.mStrideX;
//            }
//
//            public int getDataStrideY() {
//                return CopyOfIDisplayOpenGLView.this.mStrideY;
//            }
//
//            public int getDataWidth() {
//                return CopyOfIDisplayOpenGLView.this.mWidth;
//            }
//
//            public void renderDataUpdated(boolean z) {
//                if (z) {
//                    CopyOfIDisplayOpenGLView.this.reInitTextureBuffer();
//                }
//                CopyOfIDisplayOpenGLView.this.isDirty = true;
//                FPSCounter.imageRenderComplete();
//                CopyOfIDisplayOpenGLView.this.requestRender();
//                if (CopyOfIDisplayOpenGLView.this.mSingleCodeDevice) {
//                    Thread.yield();
//                }
//            }
//
//            public void setDataHeight(int i) {
//                CopyOfIDisplayOpenGLView.this.mHeight = i;
//            }
//
//            public void setDataStrideX(int i) {
//                CopyOfIDisplayOpenGLView.this.mStrideX = i;
//            }
//
//            public void setDataStrideY(int i) {
//                CopyOfIDisplayOpenGLView.this.mStrideY = i;
//            }
//
//            public void setDataWidth(int i) {
//                CopyOfIDisplayOpenGLView.this.mWidth = i;
//            }
//        };
